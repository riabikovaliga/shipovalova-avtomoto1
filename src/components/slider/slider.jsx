...
const Slider = () => {
  ...
  return <div className="slider">
    ...
    <div className="slider__bar">
      <button className={`slider__btn slider__btn--up ${activeImg === 0 ? `slider__btn--disable` : ``}`} onClick={onPreviousImgClick} disabled={activeImg === 0 ? true : false} aria-label="Предыдущее изображение">
      ...
      <button className={`slider__btn slider__btn--down ${activeImg === pictures.length - 1 ? `slider__btn--disable` : ``}`} onClick={onNextImgClick} disabled={activeImg === pictures.length - 1 ? true : false} aria-label="Следующее изображение">
